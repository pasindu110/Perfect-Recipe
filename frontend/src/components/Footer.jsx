      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-bold text-primary">PerfectRecipe</span>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/recipes" className="text-base text-gray-600 hover:text-primary">
                  Recipes
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/about-us" className="text-base text-gray-600 hover:text-primary">
                  About Us
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12">
          ...
          <form className="mt-4 sm:flex">
            ...
            <button
              type="submit"
              className="mt-3 sm:mt-0 sm:ml-3 w-full sm:w-auto px-6 py-2 bg-primary text-white rounded-md hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
            >
              Subscribe
            </button>
          </form>
