...
const RecipeList = () => {
  ...
  const cuisineOptions = ['All', ...Array.from(new Set(recipes.map(r => r.cuisine).filter(Boolean)))];
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8 gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center">
          <select
            ...
            className="border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-rose-500"
          >
